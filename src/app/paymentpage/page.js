            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 sticky top-6">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 mb-8">
                ...
                <div className="flex items-baseline">
                  <span className="text-white text-5xl font-bold">₹4999</span>
              ...
              {/* Coupon Section */}
              <div className="mb-8">
                <p className="text-sm text-gray-700 mb-3 font-normal">
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-base"
                  />
                  <button
              ...
              <div className="border-t border-gray-200 pt-6 space-y-4 mb-8">
                ...
                <div className="flex justify-between text-gray-900 pt-4 border-t border-gray-200">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-3.5 rounded-lg hover:bg-blue-700 transition-all font-medium text-base"
              >
