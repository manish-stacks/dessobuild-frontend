...
export default function VastuDesigners() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation */}
      <Header activePage="interior-designers" />
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-8">
            Work with top-rated interior designers who turn ideas into stunning, livable designs.
          </p>
      ...
      <section className="bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 ">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {vastu.map((vastu) => (
              <div key={vastu.id} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                {/* Header */}
                <div className="p-5 border-b border-gray-100 bg-[#E9F5D6]">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 text-lg">{vastu.name}</h3>
                        <p className="text-sm text-gray-500">{vastu.location}</p>
                      </div>
                    </div>
                    {vastu.verified && (
                      <div>
                  ...
                  <div className="flex items-center space-x-4 text-sm">
                    <div>
                      <div className="font-semibold text-gray-900">{vastu.pricePerMin}</div>
                      <div className="text-gray-500 text-xs">Price</div>
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900">{vastu.experience}</div>
